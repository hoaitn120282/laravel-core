...
<img id="btn-upload-image-preview" class="img-responsive"
     src="{{ ($model != "" ) ? $model->getMetaValue('featured_img') : old('meta[featured_img]') }}"/>
<input type="hidden" id="meta_featured_img" class="form-control" name="meta[featured_img]"
       value="{{ ($model != "" ) ? $model->getMetaValue('featured_img') : old('meta[featured_img]') }}"
       placeholder="Meta Featured Image">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs" role="tablist">
                    <li id="tab-home" role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"
                                                                            data-toggle="tab">Upload Image</a></li>
                    <li id="tab-image" role="presentation"><a href="#image" aria-controls="image" role="tab"
