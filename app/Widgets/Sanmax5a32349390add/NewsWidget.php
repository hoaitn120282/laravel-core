...
class NewsWidget extends BaseWidget
{
    ...
    public function form()
    {
        ...
        return \View::make('widgets.Sanmax5a32349390add.NewsWidget.form', ['options' => $this->options, 'categories' => $categories])->render();
    }
    ...
    public function run()
    {
        ...
        return \View::make('widgets.Sanmax5a32349390add.NewsWidget.run', ['model' => $model, 'options' => $this->options])->render();
    }
}