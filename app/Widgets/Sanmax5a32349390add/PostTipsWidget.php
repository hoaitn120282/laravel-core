...
class PostTipsWidget extends BaseWidget
{
    ...
    public function form()
    {
        ...
        return \View::make('widgets.Sanmax5a32349390add.PostTipsWidget.form', ['options' => $this->options, 'categories' => $categories])->render();
    }
    ...
    public function run()
    {
        ...
        return \View::make('widgets.Sanmax5a32349390add.PostTipsWidget.run', ['model' => $model->chunk(3), 'options' => $this->options])->render();
    }
}