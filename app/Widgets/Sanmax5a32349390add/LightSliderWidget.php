...
class LightSliderWidget extends BaseWidget
{
    ...
    public function form(){
        ...
        return \View::make('widgets.Sanmax5a32349390add.LightSliderWidget.form', [
            'options' => $this->options, 'model' => $model, 'galleries' => $galleries, 'theme'=>"Sanmax5a32349390add", 'widget'=>"LightSliderWidget"
        ])->render();
    }
    ...
    public function run(){
        ...
        return \View::make('widgets.Sanmax5a32349390add.LightSliderWidget.run', ['model' => $model, 'options' => $this->options])->render();
    }
}