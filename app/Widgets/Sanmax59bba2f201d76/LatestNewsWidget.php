...
class LatestNewsWidget extends BaseWidget
{
    ...
    public function form(){
        return \View::make('widgets.Sanmax59bba2f201d76.LatestNewsWidget.form',['options'=>$this->options])->render();
    }

    public function run(){
        $model = Articles::where("post_type","post")->take($this->options['show'])->skip(0)->get();
        return \View::make('widgets.Sanmax59bba2f201d76.LatestNewsWidget.run',['options'=>$this->options,'model'=>$model])->render();
    }
}