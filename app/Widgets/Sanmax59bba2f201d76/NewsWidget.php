...
class NewsWidget extends BaseWidget
{
    ...
    public function form()
    {
        ...
        return \View::make('widgets.Sanmax59bba2f201d76.NewsWidget.form', ['options' => $this->options, 'categories' => $categories])->render();
    }
    ...
    public function run()
    {
        ...
        return \View::make('widgets.Sanmax59bba2f201d76.NewsWidget.run', ['model' => $model, 'options' => $this->options])->render();
    }
}