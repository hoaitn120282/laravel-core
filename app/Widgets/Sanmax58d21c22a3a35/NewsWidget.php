...
class NewsWidget extends BaseWidget
{
    ...
    public function form()
    {
        ...
        return \View::make('widgets.Sanmax58d21c22a3a35.NewsWidget.form', ['options' => $this->options, 'categories' => $categories])->render();
    }
    ...
    public function run()
    {
        ...
        return \View::make('widgets.Sanmax58d21c22a3a35.NewsWidget.run', ['model' => $model, 'options' => $this->options])->render();
    }
}