...
class ContactInfoWidget extends BaseWidget
{
    ...
    public function form(){
        return \View::make('widgets.Sanmax596435ab10077.ContactInfoWidget.form',['options'=>$this->options])->render();
    }

    public function run(){
        return \View::make('widgets.Sanmax596435ab10077.ContactInfoWidget.run',['options'=>$this->options])->render();
    }
