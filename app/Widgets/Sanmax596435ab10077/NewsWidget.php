...
class NewsWidget extends BaseWidget
{
    ...
    public function form()
    {
        ...
        return \View::make('widgets.Sanmax596435ab10077.NewsWidget.form', ['options' => $this->options, 'categories' => $categories])->render();
    }
    ...
    public function run()
    {
        ...
        return \View::make('widgets.Sanmax596435ab10077.NewsWidget.run', ['model' => $model, 'options' => $this->options])->render();
    }
}