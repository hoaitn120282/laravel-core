...
class PostTipsWidget extends BaseWidget
{
    ...
    public function form()
    {
        ...
        return \View::make('widgets.Sanmax596435ab10077.PostTipsWidget.form', ['options' => $this->options, 'categories' => $categories])->render();
    }
    ...
    public function run()
    {
        ...
        return \View::make('widgets.Sanmax596435ab10077.PostTipsWidget.run', ['model' => $model->chunk(3), 'options' => $this->options])->render();
    }
}