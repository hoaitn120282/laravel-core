...
class LightSliderWidget extends BaseWidget
{
    ...
    public function form(){
        ...
        return \View::make('widgets.Sanmax58cbc3aba9843.LightSliderWidget.form', [
            'options' => $this->options, 'model' => $model, 'galleries' => $galleries, 'theme'=>"Sanmax58cbc3aba9843", 'widget'=>"LightSliderWidget"
        ])->render();
    }
    ...
    public function run(){
        ...
        return \View::make('widgets.Sanmax58cbc3aba9843.LightSliderWidget.run', ['model' => $model, 'options' => $this->options])->render();
    }
}