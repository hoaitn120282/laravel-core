                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="comment_name" class="form-control" id="comment-name"
                                           placeholder="Name">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="comment_email" class="form-control" id="comment-email"
                                           placeholder="Email">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="comment_website" class="form-control" id="comment-website"
                                           placeholder="Website">
                                </div>
                            </div>
                        </div>
